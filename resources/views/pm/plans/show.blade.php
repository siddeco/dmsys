    ...
    @endif
        ...
        @if($record->breakdown)
            <div class="card shadow-sm mt-3 border-danger">
                ...
                <div class="card-body">
                    <div><strong>Title:</strong> {{ $record->breakdown->title }}</div>
                    <div class="mt-1"><strong>Status:</strong>
                        <span class="badge bg-warning text-dark">
                            {{ ucfirst($record->breakdown->status) }}
                        </span>
                    </div>

                    <div class="mt-2">
                        <strong>Description:</strong>
                        <p class="mb-2">{{ $record->breakdown->description }}</p>
                    </div>

                    <a href="{{ route('breakdowns.show', $record->breakdown->id) }}" class="btn btn-outline-danger btn-sm">
