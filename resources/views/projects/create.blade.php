                            ...
                            <div class="alert alert-info border-0 bg-light-info">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0">يرجى ملء المعلومات الأساسية أولاً (الجزء ١ و ٢)، باقي الحقول اختيارية.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="code" class="form-control @error('code') is-invalid @enderror"
                                            value="{{ old('code') }}" placeholder="سيتم إنشاؤه تلقائياً">
                                        <small class="text-muted">اتركه فارغاً لإنشاء رمز تلقائي: PROJ-YYYY-XXX</small>
                                        @error('code')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="client_name"
                                            ...
                                            value="{{ old('client_name') }}" placeholder="أدخل اسم العميل يدوياً">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="client_type"
                                            ...
                                            <option value="hospital" {{ old('client_type') == 'hospital' ? 'selected' : '' }}>
                                                مستشفى</option>
                                            <option value="clinic" {{ old('client_type') == 'clinic' ? 'selected' : '' }}>عيادة
                                            </option>
                                            <option value="laboratory" {{ old('client_type') == 'laboratory' ? 'selected' : '' }}>
                                                مختبر</option>
                                            <option value="pharmacy" {{ old('client_type') == 'pharmacy' ? 'selected' : '' }}>
                                                صيدلية</option>
                                            <option value="government" {{ old('client_type') == 'government' ? 'selected' : '' }}>
                                                حكومي</option>
                                            <option value="company" {{ old('client_type') == 'company' ? 'selected' : '' }}>شركة
                                            </option>
                                            <option value="other" {{ old('client_type') == 'other' ? 'selected' : '' }}>أخرى
                                            </option>
                                        </select>
                                        @error('client_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="city" class="form-control @error('city') is-invalid @enderror"
                                            value="{{ old('city') }}" placeholder="المدينة">
                                        @error('city')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" class="form-control @error('address') is-invalid @enderror"
                                            rows="2"
                                            placeholder="أدخل العنوان التفصيلي للمشروع...">{{ old('address') }}</textarea>
                                        @error('address')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-select @error('status') is-invalid @enderror"
                                            required>
                                            <option value="active" {{ old('status') == 'active' ? 'selected' : 'selected' }}>نشط
                                            </option>
                                            <option value="completed" {{ old('status') == 'completed' ? 'selected' : '' }}>مكتمل
                                            </option>
                                            <option value="on_hold" {{ old('status') == 'on_hold' ? 'selected' : '' }}>متوقف
                                            </option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="contract_number"
                                            ...
                                            value="{{ old('contract_number') }}" placeholder="رقم العقد">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="warranty_period"
                                                ...
                                                value="{{ old('warranty_period') }}" placeholder="12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="notes" class="form-control @error('notes') is-invalid @enderror"
                                            rows="4"
                                            placeholder="أي ملاحظات إضافية حول المشروع...">{{ old('notes') }}</textarea>
                                        @error('notes')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                    ...
                    <div class="row mt-5">
                        <div class="col-12">
                            <div class="d-flex justify-content-between border-top pt-4">
                                ...
                                <div>
                                    <a href="{{ route('projects.index') }}" class="btn btn-outline-danger me-2">
        ...
        <div class="alert alert-danger border-0 shadow-sm mt-4">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="mb-0">{{ __('ليس لديك الصلاحيات اللازمة لإضافة مشاريع جديدة.') }}</p>
                </div>
            </div>
        </div>
    @endcan
...
@push('styles')
    <style>
        /* نفس الأنماط من صفحة إضافة الجهاز */
        .section-card {
            background: white;
            border-radius: 12px;
