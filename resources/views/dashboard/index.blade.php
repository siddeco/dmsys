        ...
        <div class="container-fluid">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6 mb-3">
                    <a href="{{ route('breakdowns.index', ['assigned' => 'me']) }}" class="small-box bg-danger text-white">
                        <div class="inner">
                            <h3>{{ $myBreakdowns }}</h3>
                ...
                {{-- My PM --}}
                <div class="col-md-6 mb-3">
                    <a href="{{ route('pm.plans.index', ['assigned' => 'me']) }}" class="small-box bg-primary text-white">
                        <div class="inner">
                            <h3>{{ $myPmPlans }}</h3>
                            <p>My PM Tasks</p>
                        </div>
                        ...
                        <tbody>
                            @forelse($latestBreakdowns as $b)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('breakdowns.show', $b->id) }}" class="btn btn-sm btn-outline-primary">
                                            View
                                        </a>
                                    </td>
                                </tr>
    ...
    @else
        ...
        <div class="container-fluid">
            ...
            <div class="row mb-4">
                ...
                <div class="col-lg-3 col-md-6 mb-3">
                    <a href="{{ route('breakdowns.index', ['status' => 'open']) }}" class="small-box bg-danger text-white">
                        <div class="inner">
                ...
                <div class="col-lg-3 col-md-6 mb-3">
                    <a href="{{ route('pm.plans.index', ['filter' => 'due_soon']) }}" class="small-box bg-primary text-white">
                        <div class="inner">
                            <h3>{{ $pmDueSoon }}</h3>
                            <p>PM Due (30 Days)</p>
                        </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-lg-3 col-md-6 mb-3">
                    <a href="{{ route('spare_parts.index', ['low_stock' => 1]) }}" class="small-box bg-secondary text-white">
                        <div class="inner">
                            <h3>{{ $lowStockParts ?? 0}}</h3>
                            <p>Low Stock Parts</p>
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <div class="alert alert-warning d-flex align-items-center justify-content-between shadow-sm">
                                ...
                                <a href="{{ route('pm.plans.index', ['overdue' => 1]) }}" class="btn btn-sm btn-outline-dark">
                                    View Overdue PM
                                </a>
                            </div>
                        </div>
